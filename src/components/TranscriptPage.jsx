  ...
  return (
    <div className="bg-gray-100 flex flex-col min-h-screen justify-between">
      ...
      <header className="text-white text-center">
        <div className="bg-blue-600 pt-12 pb-12 shadow-md rounded-b-3xl fixed top-0 left-0 w-full z-10">
      ...
      <main className="flex-grow flex px-6 mt-40 mb-32 justify-center items-start">
        ...
        <div className="max-w-md px-3 py-6 flex flex-col items-center w-full">
          ...
          <button
            ...
            className="fixed bottom-24 left-1/2 transform -translate-x-1/2 bg-blue-600 text-white text-lg font-semibold py-3 px-6 rounded-full mt-4 w-full max-w-xs hover:bg-blue-700 transition duration-200 shadow-md"
          >
            Summarize
          </button>
        </div>
