    ...
    <div className="bg-gray-100 flex flex-col min-h-screen">
        ...
        <main className="flex-grow flex flex-col items-center mt-40 md:pb-20 py-8 px-4 z-30 relative">
            ...
            <div>
                ...
                <h1 className="text-4xl font-bold mb-2 text-center"> 90% </h1>
                <p className="text-md text-center"> You got <span className="text-blue font-bold"> 9/10 </span> questions right! Click below to review your answers. </p>
            </div>
        ...
        <nav className="bg-white text-gray-600 shadow-t-lg py-3 flex justify-around items-center fixed bottom-0 inset-x-0 z-30">
