import {
  version
} from "./chunk-2LQSWTT6.js";
import {
  selectSvgElement
} from "./chunk-QRBD3ZBN.js";
import {
  JSON_SCHEMA,
  load
} from "./chunk-DQ7TFXTY.js";
import {
  registerLayoutLoaders
} from "./chunk-XQ6SCUF3.js";
import "./chunk-5VGX77H2.js";
import {
  registerIconPacks
} from "./chunk-26CPRYJT.js";
import "./chunk-4BM7FUSR.js";
import {
  dedent
} from "./chunk-UMXJSC5L.js";
import {
  cleanAndMerge,
  decodeEntities,
  encodeEntities,
...
import {
  ...
  themes_default,
  updateSiteConfig
} from "./chunk-FKKAQ5K6.js";
import {
  isEmpty_default
} from "./chunk-BBUSXV25.js";
import "./chunk-I6RL7E24.js";
import "./chunk-YEZOG3UA.js";
...
var loader = __name(async () => {
  const { diagram: diagram2 } = await import("./c4Diagram-ZCSEYPFN-2AGFFFH2.js");
...
var loader2 = __name(async () => {
  const { diagram: diagram2 } = await import("./flowDiagram-NWEUNK3L-7XI4YC4I.js");
...
var loader4 = __name(async () => {
  const { diagram: diagram2 } = await import("./erDiagram-DKC2X5TE-U6APX3EN.js");
...
var loader5 = __name(async () => {
  const { diagram: diagram2 } = await import("./gitGraphDiagram-JPZ3KUXI-QQBJTIAG.js");
...
var loader6 = __name(async () => {
  const { diagram: diagram2 } = await import("./ganttDiagram-HLVPPPRE-ZRDMM7MD.js");
...
var loader7 = __name(async () => {
  const { diagram: diagram2 } = await import("./infoDiagram-RZZSJVI2-UOWZYLWT.js");
...
var loader8 = __name(async () => {
  const { diagram: diagram2 } = await import("./pieDiagram-X7YZ5ZEZ-DNOFM673.js");
...
var loader9 = __name(async () => {
  const { diagram: diagram2 } = await import("./quadrantDiagram-F36EZAVT-6EYMGGAB.js");
...
var loader10 = __name(async () => {
  const { diagram: diagram2 } = await import("./xychartDiagram-KECQ2H5Q-CPTS4ULP.js");
...
var loader11 = __name(async () => {
  const { diagram: diagram2 } = await import("./requirementDiagram-JG2LMPGF-QGLCMYQ2.js");
...
var loader12 = __name(async () => {
  const { diagram: diagram2 } = await import("./sequenceDiagram-WK7YDQ3N-SAUGN3HH.js");
...
var loader13 = __name(async () => {
  const { diagram: diagram2 } = await import("./classDiagram-Q73GJZWF-ZXQV35YQ.js");
...
var loader14 = __name(async () => {
  const { diagram: diagram2 } = await import("./classDiagram-v2-C6QPLPW4-7NIEW4VW.js");
...
var loader15 = __name(async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-4JV6CC6H-OJBBIIHL.js");
...
var loader16 = __name(async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-v2-7KT6RKTD-YWHIB4YE.js");
...
var loader17 = __name(async () => {
  const { diagram: diagram2 } = await import("./journeyDiagram-BLD6N6MZ-7S77PAAH.js");
...
var loader19 = __name(async () => {
  const { diagram: diagram2 } = await import("./timeline-definition-3ZMEY6HS-J52AXEHL.js");
...
var loader20 = __name(async () => {
  const { diagram: diagram2 } = await import("./mindmap-definition-OEB2RXX2-AAF6BYGS.js");
...
var loader21 = __name(async () => {
  const { diagram: diagram2 } = await import("./sankeyDiagram-ATFNWWW6-YHUC44CS.js");
...
var loader22 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-AVGMFHF7-ZXZFCAMG.js");
...
var loader23 = __name(async () => {
  const { diagram: diagram2 } = await import("./blockDiagram-TCMKQVZ6-MX7SWOH4.js");
...
var loader24 = __name(async () => {
  const { diagram: diagram2 } = await import("./architectureDiagram-IFBEXTG3-63PLXJ2I.js");
